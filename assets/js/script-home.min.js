...
$(this).data("clicks",!clicks);$('.header').toggleClass('header--active')})});$(function(){var scrollLink=$('nav a[href^="#"], .hero a[href^="#"]');scrollLink.click(function(e){e.preventDefault();var id=$(this).attr('href'),targetOffset=$(id).offset().top,menuHeight=$('.header').innerHeight();$('html, body').animate({scrollTop:targetOffset-menuHeight*1.5},1000)})});/**
 * Owl Carousel v2.3.4
...
if(tests.csstransforms()){$.support.transform=new String(prefixed('transform'));$.support.transform3d=tests.csstransforms3d()}})(window.Zepto||window.jQuery,window,document);$(function(){$(".testimonial__carousel").owlCarousel({margin:10,loop:!0,autoplay:!0,autoplayTimeout:3500,autoplayHoverPause:!0,responsive:{0:{items:1,nav:!1},600:{items:1,nav:!1},1000:{items:1,nav:!1}}})});/*! Magnific Popup - v1.1.0 - 2016-02-20
...
config.trigger=target;result.push(ScrollTrigger.create(config))});return result};ScrollTrigger.sort=function(func){return _triggers.sort(func||function(a,b){return(a.vars.refreshPriority||0)*-1e6+a.start-(b.start+(b.vars.refreshPriority||0)*-1e6)})};_getGSAP()&&gsap.registerPlugin(ScrollTrigger);exports.ScrollTrigger=ScrollTrigger;exports.default=ScrollTrigger;Object.defineProperty(exports,'__esModule',{value:!0})})))