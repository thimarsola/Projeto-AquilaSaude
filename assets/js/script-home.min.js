...
$(this).data("clicks",!clicks);$('.header').toggleClass('header--active')})});$(function(){var scrollLink=$('nav a[href^="#"], .hero a[href^="#"]');scrollLink.click(function(e){e.preventDefault();var id=$(this).attr('href'),targetOffset=$(id).offset().top,menuHeight=$('.header').innerHeight();$('html, body').animate({scrollTop:targetOffset-menuHeight*1.5},1000)})});$(function(){$('.gallery__grid').magnificPopup({delegate:'a',type:'image',gallery:{enabled:!0}})});/**
 * Owl Carousel v2.3.4
