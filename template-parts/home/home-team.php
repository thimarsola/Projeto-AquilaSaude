    ...
    <div class="container">
        ...
        <div class="team__row">
            ...
            <div class="team__row__body">
                ...
                <p>A <b>clínica Áquila Saúde</b> possui uma estrutura diferenciada, tecnologia de última geração e reúne
                    profissionais atualizados e altamente capacitados de todas as áreas da Odontologia.</p>

                <!-- link -->
                <div class="team__row__body__link">
                    <a href="<?= get_permalink(get_page_by_title('Profissionais')); ?>" class="btn btn-blue-500"
                        target="_blank">Conheça a nossa Equipe</a>
                </div>
                <!-- end of link -->
            </div>
            <!-- end of body -->
